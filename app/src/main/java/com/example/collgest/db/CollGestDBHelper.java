...
System.out.println("oldVersion : " + oldVersion + " / newVersion : " + newVersion);
    ...
    public List<CollGestItem> getAllGestItem(SQLiteDatabase db) {
        ...
        List<CollGestItem> gestItemList = new ArrayList<CollGestItem>();
        // Select All Query
    ...
    public int updateGestItem(CollGestItem collGestItem) {
        ...
        // updating row
        return db.update(TABLE_ITEM, values, COLUMN_ITEM_GUID + " = ?",
